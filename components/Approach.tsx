    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="Analyze the design and break it into smaller components, considering the project requirements."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des=" Select the most suitable languages, tools, and component libraries that align with the project requirements."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          des="Begin the development process, implementing each component step by step."
        >
          <CanvasRevealEffect
            animationSpeed={3}
